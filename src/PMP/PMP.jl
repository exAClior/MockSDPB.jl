...
struct PolynomialMatrixProblem{VT<:AbstractVector{<:Number},PM<:AbstractMatrix{<:AbstractPMWP},PMV<:AbstractVector{MP}} <: AbstractBootStrapProblem
    # precision::Int this field should be encoded into VT's T 
    objective::VT
    normalization::VT
    positiveMatricesWithPrefactor::VMV
end
